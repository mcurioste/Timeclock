<?php
  ...
  if ($resultCheck > 0) {
    ...
    echo "<button type='submit' name='edit-std'>Edit User</button>";
    echo "<button type='submit' name='chg-pwd-std'>Change Password</button>";
    echo "<button type='submit' name='forgot-pwd'>Forgot Password</button>";
  }
