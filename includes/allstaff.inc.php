<?php
  ...
  if ($resultCheck > 0) {
    ...
    echo "<button type='submit' name='edit-stf'>Edit User</button>";
    echo "<button type='submit' name='chg-pwd-stf'>Change Password</button>";
    echo "<button type='submit' name='show-login'>Show Login</button>";
