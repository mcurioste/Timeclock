...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      <h2>New Student</h2>
      <form class="newstf" action="../includes/stdsignup.inc.php" method="post">
        ...
        <button type="submit" name="newstd-submit">submit</button>
        <div class="user-create">
         ...
         echo ("<h2>Student signup successful!</h2>");
       }
          ?>
        </div>
      </form>
