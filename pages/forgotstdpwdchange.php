...
if (!isset($_SESSION['id'])) {
  header("Locatioan: allstudents.php");
}
 ?>
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      ...
      <form class="newstf" action="../includes/forgotstdpwdchange.inc.php" method="post">
        ...
        <button type="submit" name="chgpwdstd-submit">submit</button>
